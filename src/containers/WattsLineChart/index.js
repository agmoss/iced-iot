...
class WattsLineChartContainer extends Component {
    ...
    async energyLineChart() {
        ...
        await this.getDataFor('/devices/facility/' + this.state.currentFacility + '/type/energy/gte/' + xHoursAgo, 'energyTs');
    ...
    startUpdatingData() {
        ...
        this.chartInterval = setInterval(() => {
            ...
            now.setHours(now.getHours() - this.state.hourLag);
            var xHoursAgo = now.getTime().toString();
            this.getDataFor('/devices/facility/' + this.state.currentFacility + '/type/energy/gte/' + xHoursAgo, 'energyTs');
    ...
    render() {
        return (
            React.createElement(WattsLineChart, { options: this.state.options, series: this.state.series, currentFacility: this.props.currentFacility })
        )
    }
}
